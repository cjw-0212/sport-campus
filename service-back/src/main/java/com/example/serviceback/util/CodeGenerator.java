...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://192.168.255.141:3306/sports_campus?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai");
        ...
        //设置生成包的父路径
        pc.setParent("com.example.serviceback");
        //设置生成实体类的包名
        pc.setEntity("po");
